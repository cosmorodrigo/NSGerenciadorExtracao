...
using NSGerenciadorExtracao;

[assembly: PreApplicationStartMethod(typeof(SwaggerConfig), "Register")]

namespace NSGerenciadorExtracao
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "NSGerenciadorExtracao");
    ...
    internal class IncludeParameterNamesInOperationIdFilter : IOperationFilter
    {
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
            ...
            if (operation.operationId == "Configuracao_LayoutUpload")
            {
